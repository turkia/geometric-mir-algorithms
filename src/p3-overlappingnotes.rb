...
# prototype of P3 which ignores overlapping note segments by using counters.
...
class VerticalTranslationTable
	...
	def initialize(pattern_size)
		@items = []
		256.times do |i|
			items[i] = VerticalTranslationTableItem.new(i, 0, 0, pattern_size)
		end
	end
end
...
verticaltranslationtable = VerticalTranslationTable.new(p.size)
...
puts "longest common duration=#{best}"
